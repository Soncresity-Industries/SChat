                ...
                <Stack style={{ paddingVertical: 24, paddingHorizontal: 12 }} spacing={24}>
                    ...
                    <TableRowGroup title="Other">
                        <TableRow
                            ...
                            onPress={() => navigation.push("SCHAT_CUSTOM_PAGE", {
                        ...
                        <TableRow
                            ...
                            onPress={() => showSimpleActionSheet({
                                ...
                                options: [
                                    ...
                                    { label: Strings.SCHAT, onPress: () => navigation.push("SCHAT_CUSTOM_PAGE", { render: () => <undefined /> }) },
                                    { label: "Discord", isDestructive: true, onPress: () => navigation.push("SCHAT_CUSTOM_PAGE", { noErrorBoundary: true }) },
                                ],
                            })}
                        />
                        <TableRow
