...
import { SChatPluginManifestInternal } from "@lib/addons/plugins/types";
...
function PluginCard(props: { manifest: SChatPluginManifestInternal; }) {
            ...
            <AlertActionButton
                ...
                onPress={async () => {
                    try {
                        ...
                        dismissAlert("schat-add-plugin-repository");
                        showSheet("plugin-browser-options", PluginBrowserOptions);
                    }
                }} />
        </AlertActions>} />;
    ...
    return <ActionSheet>
        <TableRowGroup title="Repositories">
            ...
            <TableRow
                ...
                onPress={() => {
                    openAlert("schat-add-plugin-repository", <AddRepositoryAlert />);
...
function RepositoryRow(props: { url: string; }) {
    ...
    return (
        <TableRow
            label={isOfficial ? "SChat's Repository" : (repo.$meta?.name ?? "Unknown")}
            subLabel={props.url}
            trailing={(
                <Stack direction="horizontal">
                    ...
                    <IconButton
                        ...
                        onPress={() => {
                            openAlert("schat-remove-repository", <AlertModal
                                ...
                                actions={<AlertActions>
                                    <AlertActionButton
                                        ...
                                        onPress={async () => {
                                            ...
                                            dismissAlert("schat-remove-repository");
                                        }}
                                    />
                                </AlertActions>}
                            />);
