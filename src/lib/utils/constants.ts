export const DISCORD_SERVER = "https://discord.gg/uqbQvAHHve";
export const GITHUB = "https://github.com/Soncresity-Industries/SChat-Tweak";
...
export const SCHAT_PROXY_PREFIX = "https://bn-plugins.github.io/vd-proxy";
