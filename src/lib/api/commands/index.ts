import { ApplicationCommand, ApplicationCommandInputType, ApplicationCommandType, SChatApplicationCommand } from "@lib/api/commands/types";
...
export function registerCommand(command: SChatApplicationCommand): () => void {
